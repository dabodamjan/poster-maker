...
4. **Verify the setup** — export two of the included examples to confirm everything works:
   - Run `node scripts/export.js posters/releaserocket-app-icon.html` — the [ReleaseRocket](https://www.releaserocket.io/) app icon (1024x1024), drawn with inline SVG and CSS, no external assets, on a transparent background. Output: `exports/releaserocket-app-icon.png`
